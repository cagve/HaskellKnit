...
/* package Api-Knitting-0.1.0.0 */
#ifndef VERSION_Api_Knitting
#define VERSION_Api_Knitting "0.1.0.0"
#endif /* VERSION_Api_Knitting */
#ifndef MIN_VERSION_Api_Knitting
#define MIN_VERSION_Api_Knitting(major1,major2,minor) (\
  (major1) <  0 || \
  (major1) == 0 && (major2) <  1 || \
  (major1) == 0 && (major2) == 1 && (minor) <= 0)
#endif /* MIN_VERSION_Api_Knitting */
...
/* package attoparsec-aeson-2.1.0.0 */
#ifndef VERSION_attoparsec_aeson
#define VERSION_attoparsec_aeson "2.1.0.0"
...
#define CURRENT_COMPONENT_ID "Api-Knitting-0.1.0.0-HfdS7r7lTKCA9MmCtkRJDE-my-api-project-exe"
